...
# velocities_filtered = butter_lowpass_filter(velocities, cutoff, fs, order)

# x_velocities_filtered = butter_lowpass_filter(x_velocities, cutoff, fs, order)
# y_velocities_filtered = butter_lowpass_filter(y_velocities, cutoff, fs, order)

# plt.subplot(2, 2, 1)
# plt.title("position")
# plt.plot(x, y, 'b-', label='data')
# plt.plot(x_position_filtered, y_position_filtered,
#          'g-', linewidth=2, label='filtered data')
# plt.xlim([0, 1280])
# plt.ylim([0, 720])
# plt.grid()
# plt.legend()
...
# plt.subplot(2, 2, 2)
# plt.title("velocity")
# plt.plot(t, velocities, 'b-', label='data')
# plt.plot(t, velocities_filtered, 'g-', linewidth=2, label='filtered data')
# plt.xlabel('Time [sec]')
# plt.grid()
# plt.legend()
...
# plt.plot(t, x_velocities, 'b-', label='data')
# plt.plot(t, x_velocities_filtered, 'g-', linewidth=2, label='filtered data')
# plt.xlabel('Time [sec]')
# plt.grid()
# plt.legend()
...
# plt.plot(t, y_velocities, 'b-', label='data')
# plt.plot(t, y_velocities_filtered, 'g-', linewidth=2, label='filtered data')
# plt.xlabel('Time [sec]')
# plt.grid()
# plt.legend()
